...
namespace ElasticSearch.API.DTOs
{
    public record ResponseDto<T>
    {
        ...
        // Overload yaptık. Tek bir tane dönebileceği gibi çoklu da dönebilir. --------------------------------
        ...
        {
            return new ResponseDto<T> { Errors = new List<string> {error}, Status = status }; // Burada tek bir hata verecek ve Listemie hatamıı kendi ekleyecek.
        }
        // -----------------------------------------------------------------------------------------------------
    }
}
